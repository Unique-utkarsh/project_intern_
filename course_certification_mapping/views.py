...
class CourseCertificationMappingListView(APIView):
    ...
    def get(self, request):
        ...
        if cert_id := request.query_params.get('certification_id'):
    ...
    @swagger_auto_schema(request_body=CourseCertificationMappingSerializer, responses={201: CourseCertificationMappingSerializer, 400: "Validation Error"})
...
class CourseCertificationMappingDetailView(APIView):
    ...
    def get(self, request, pk):
        obj, err = get_object_or_404_response(CourseCertificationMapping, pk=pk)
        if err: return err
        return Response(CourseCertificationMappingSerializer(obj).data)

    @swagger_auto_schema(request_body=CourseCertificationMappingSerializer, responses={200: CourseCertificationMappingSerializer, 400: "Validation Error", 404: "Not Found"})
